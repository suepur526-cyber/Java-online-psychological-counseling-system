...
- 普通用户注册、心理老师注册。
- 普通用户所有菜单页面、列表数据、预约弹窗、咨询弹窗、心理测试答题弹窗。
- 心理老师所有菜单页面、预约审核弹窗、咨询回复弹窗、测试维护和题库维护弹窗。
- 管理员所有菜单页面、用户启用/禁用、老师审核、公告维护、测试编辑、系统介绍维护。
- 边缘按钮和负向分支：示例账号按钮、错误登录提示、预约/咨询/测试/测试维护取消、预约驳回、老师驳回、公告编辑与删除、题目编辑。
- 平板宽度和移动端登录页布局检查，验证无横向遮挡、切割或不可见溢出。
